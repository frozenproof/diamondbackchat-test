...
import { ServerSearchBar } from "@/components/display/server/server-search";
...
import { ChannelSideBar } from "@/components/display/channel/channel-sidebar";
import { MemberSideBar } from "@/components/display/member/member-sidebar";
